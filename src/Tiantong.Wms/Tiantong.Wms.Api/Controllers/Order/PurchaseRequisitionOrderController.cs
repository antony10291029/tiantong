...
{
  public class PurchaseRequisitionOrderController : BaseController
  {
    private PurchaseRequisitionOrderRepository _orders;

    public PurchaseRequisitionOrderController(PurchaseRequisitionOrderRepository orders)
    {
      _orders = orders;
    }
    ...
    public object Finish([FromBody] FinishParams param)
    {
      ...
      return SuccessOperation("领料单已出库");
    }
    ...
    {
      return _orders.Find(param.warehouse_id, param.order_id, OrderType.PurchaseRequisition);
    }
